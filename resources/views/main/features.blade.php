<section id="features" class="features">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
            <h2>سمات الجامعة</h2>
            <p>ما يمتاز به الجامعة</p>
        </header>

        <div class="row ">

            <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="500">
                <img src="/img/gedung jamiah 2.png" class="img-fluid" alt="">
            </div>
                ...
                <div class="row align-self-center gy-4">
                    ...
                    <div class="col-md-6  " data-aos="zoom-in" data-aos-delay="200">
                        <div class="feature-box d-flex align-items-center">
                            ...
                            <h3 class="me-3">السكن الداخلي</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="feature-box d-flex align-items-center">
                            <i class="bi bi-check"></i>
                            <h3 class="me-3">التربية السلوكية</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="feature-box d-flex align-items-center">
                            <i class="bi bi-check"></i>
                            <h3 class="me-3">Volup amet voluptas</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="zoom-in" data-aos-delay="500">
                        <div class="feature-box d-flex align-items-center">
                            <i class="bi bi-check"></i>
                            <h3 class="me-3">Rerum omnis sint</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="zoom-in" data-aos-delay="600">
                        <div class="feature-box d-flex align-items-center">
                            <i class="bi bi-check"></i>
                            <h3 class="me-3">Alias possimus</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" data-aos="zoom-in" data-aos-delay="700">
                        <div class="feature-box d-flex align-items-center">
                            <i class="bi bi-check"></i>
                            <h3 class="me-3">Repellendus mollitia</h3>
                        </div>
                    </div>
        ...
        <div class="row feture-tabs" data-aos="fade-up">
            <div class="col-lg-6">
                ...
                <ul class="nav nav-pills mb-3">
                    <li>
                        <a class="nav-link active" data-bs-toggle="pill" href="#tab1">أصول الدين</a>
                    </li>
                    <li>
                        <a class="nav-link" data-bs-toggle="pill" href="#tab2">الشريعة</a>
                    </li>
                    <li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tab1">
                        <p>التعريف بالكليات </p>
                        <div class="d-flex align-items-center mb-2">
                            <i class="bi bi-check2"></i>
                            <h4 class="me-3">رؤية الكلية</h4>
                        </div>
                        <p>كلمات عن رؤية الكلية</p>
                        <div class="d-flex align-items-center mb-2">
                            <i class="bi bi-check2"></i>
                            <h4>أهداف الكلية</h4>
                        </div>
                        <p>الكلمات عن أهداف الكليات</p>
